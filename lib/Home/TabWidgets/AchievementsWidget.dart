...
import 'package:nrm_afrosoft_flutter/Home/TabWidgets/AchievementsDetail.dart';
...
class _AchievementsWidget extends State<AchievementsWidget> {
  ...
  void get_achievements() {
    requestAPI(
      getApiURL("retrieve_all_achievements.php"),
      {"": ""},
          (loading) {
        setState(() {
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) =>
                    AchievementsDetail(achievement: achievement),
              ),
            );
          },
          child: Card(
